...
export default function recruitercamera({ navigation }) {
  ...
  async function submit() {
    ...
    if (audiosource != '') {
      ...
      const recruiterId=await AsyncStorage.getItem('recruiterId')
      const recruiterEmail=await AsyncStorage.getItem('recruiterEmail')
      ...
      <ScrollView>
        <View style={{ marginTop: 100 }} >
          ...
          <View style={{ margin: 20, flexDirection: 'column', }} >
            <Text style={{ marginTop: 50, marginBottom: 50 }}>Save time, ask for more information or have applicant answer assesment questions in advance   </Text>
            ...
            <Text style={{ marginTop: 50, marginBottom: 50, color: 'grey' }} >Personalize job post with a short video message, Pitch your product or service, communicate your company value  </Text>
            ...
            <View style={{ flexDirection: 'column' }}>
              <View style={{ flexDirection: 'row', flexWrap: "wrap", flex: 1, justifyContent: 'space-between' }} >
                ...
                <TouchableOpacity onPress={submit}  >
                  <Text style={{ textAlign: 'right', color: '#6304ed', fontWeight: 'bold', }} > {'Submit >'} </Text>
                </TouchableOpacity>
              </View>
            </View>
